...
namespace upromiscontractapi.Controllers
{
    ...
    public class AccountInfoController : ControllerBase
    {
        ...
        public async Task<ActionResult> Post([FromBody] SaveMessage<AccountInfoDTO> rec)
        {
            ...
            return Ok(new APIResult<AccountInfoDTO>() { ID = res.ID, DataSubject = res, Message = "Put was performed" });
        }
        ...
        public async Task<ActionResult> Delete([FromBody] SaveMessage<AccountInfoDTO> rec)
        {
            ...
            // return 
            return Ok(new APIResult<AccountInfoDTO>() { ID = rec.ID, DataSubject = null, Message = "Delete was performed" });
        }
        ...
        public async Task<ActionResult> GetList([FromBody] DataTableAjaxPostModel sentModel)
        {
            ...
            return Ok(new LoadResult<AccountInfoDTO>() { Data = await records.Item1.ToArrayAsync(), Pages = records.Item2, Message = "" });
        }
