/*
**             ------ IMPORTANT ------
** This file was generated by ZeroCode2 on 04/Jan/2021 22:06:17
...
namespace upromiscontractapi.Controllers
{
    ...
    public class ProposalController : ControllerBase
    {
        ...
        private readonly Business.IProposalBusinessRules BusinessRules;

        public ProposalController(IProposalRepository repo, ILoggerProvider loggerProvider,
            Business.IProposalBusinessRules businessRules)
        {
            Repository = repo;
        ...
        public async Task<ActionResult> Post([FromBody] SaveMessage<ProposalDTO> rec)
        {
            ...
            {
                return this.BadRequest(new APIResult<ProposalDTO>() { ID = 0, DataSubject = null, Message = ex.Message });
            }

            // return posted values
            return Ok(new APIResult<ProposalDTO>() { ID = res.ID, DataSubject = res, Message = "New Proposal was created.", AdditionalInfo = BusinessRules.Result.ToArray() });
        }
        ...
        public async Task<ActionResult> Put([FromBody] SaveMessage<ProposalDTO> rec)
        {
            ...
            // return posted values
            return Ok(new APIResult<ProposalDTO>() { ID = res.ID, DataSubject = res, Message = "Proposal was saved.", AdditionalInfo = BusinessRules.Result.ToArray() });
        }
