...
namespace upromiscontractapi.Controllers
{
    ...
    public class RequestController : ControllerBase
    {
        ...
        public async Task<ActionResult> Get(int id)
        {
            ...
            return Ok(new APIResult<RequestDTO>() { ID = id, DataSubject = res, Message = "Get was performed" });
        }
        ...
        public async Task<ActionResult> Post([FromBody] SaveMessage<RequestDTO> rec)
        {
            ...
            return Ok(new APIResult<RequestDTO>() { ID = res.ID, DataSubject = res, Message = "Put was performed" });
        }
        ...
        public async Task<ActionResult> Delete([FromBody] SaveMessage<RequestDTO> rec)
        {
            ...
            // return 
            return Ok(new APIResult<RequestDTO>() { ID = rec.ID, DataSubject = null, Message = "Delete was performed" });
        }
        ...
        public async Task<ActionResult> GetList([FromBody] DataTableAjaxPostModel sentModel)
        {
            ...
            return Ok(new LoadResult<RequestDTO>() { Data = await records.Item1.ToArrayAsync(), Pages = records.Item2, Message = "" });
        }
